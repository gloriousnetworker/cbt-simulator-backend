...
router.post('/admins/:adminId/subscription/activate', superAdminController.activateAdminSubscription);
router.post('/admins/:adminId/subscription/deactivate', superAdminController.deactivateAdminSubscription);
router.get('/admins/:adminId/subscription/status', superAdminController.getAdminSubscriptionStatus);
router.get('/subscription/stats', superAdminController.getSubscriptionStats);
